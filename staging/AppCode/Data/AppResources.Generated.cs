...
namespace AppCode.Data.AutoGenerated
{
  ...
  public abstract class ZAutoGenAppResources: Custom.Data.CustomItem
  {
    ...
    /// <summary>
    /// AdminBtnEvents as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("AdminBtnEvents", scrubHtml: true) etc.
    /// </summary>
    public string AdminBtnEvents => _item.String("AdminBtnEvents", fallback: "");

    /// <summary>
    /// AdminBtnNewEvent as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("AdminBtnNewEvent", scrubHtml: true) etc.
    /// </summary>
    public string AdminBtnNewEvent => _item.String("AdminBtnNewEvent", fallback: "");

    /// <summary>
    /// AdminBtnRegistrations as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("AdminBtnRegistrations", scrubHtml: true) etc.
    /// </summary>
    public string AdminBtnRegistrations => _item.String("AdminBtnRegistrations", fallback: "");

    /// <summary>
    /// AdminTitle as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("AdminTitle", scrubHtml: true) etc.
    /// </summary>
    public string AdminTitle => _item.String("AdminTitle", fallback: "");
